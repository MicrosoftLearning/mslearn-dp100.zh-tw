---
lab:
  title: 從 SDK 使用自動化機器學習
ms.openlocfilehash: 9fe1941effaf6672a2e0bd9ab663042f73a660f5
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 11/17/2021
ms.locfileid: "145195733"
---
# <a name="use-automated-machine-learning-from-the-sdk"></a>從 SDK 使用自動化機器學習
...
## <a name="use-the-sdk-to-run-an-automated-machine-learning-experiment"></a>使用 SDK 執行自動化機器學習實驗

在此練習中，執行自動化機器學習實驗的程式碼會提供在筆記本中。

1. 在 Jupyter 首頁上，流覽至您複製筆記本存放庫的 **/users/*您的使用者名稱*/mslearn-dp100** 資料夾，然後開啟 [使用自動化機器學習] 筆記本。
