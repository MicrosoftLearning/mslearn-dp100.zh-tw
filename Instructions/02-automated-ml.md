...
1. 在自動化機器學習執行的 [概觀] 索引標籤上，記下最佳模型摘要。
...
1. 在瀏覽器中開啟 **auto-predict-diabetes** 服務頁面的 [取用] 頁面之後，就會開啟新的瀏覽器索引標籤，並開啟 Azure Machine Learning 工作室的另一個執行個體。 然後，在新的索引標籤中，檢視 [筆記本] 頁面。
...
1. 在 Azure Machine Learning 工作室的 [端點] 索引標籤上，選取 **auto-predict-diabetes** 端點。 然後，選取 [刪除] (&#128465;)，並確認您要刪除該端點。
