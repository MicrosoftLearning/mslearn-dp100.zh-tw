...
ms.locfileid: "145195720"
---
# <a name="create-a-batch-inferencing-service"></a>建立批次推斷服務

在許多情況下，推斷以批次處理方式進行，運用預測模型來為大量案例評分。 若要在 Azure Machine Learning 中實作這種推斷解決方案，您可以建立批次推斷管線。
...
在此練習中，將模型部署為批次推斷服務的程式碼會提供在筆記本中。

1. 在 Jupyter 首頁上，流覽至您複製筆記本存放庫的 **/users/*您的使用者名稱*/mslearn-dp100** 資料夾，然後開啟 [批次推斷服務] 筆記本。
