...
ms.locfileid: "145195731"
---
# <a name="monitor-a-model"></a>監視模型

當您將模型部署為服務時，能追蹤其處理的要求相關資訊十分實用。

Azure Machine Learning 與 Azure Application Insights 整合，可讓您記錄已部署服務的資料。
...
## <a name="use-application-insights-to-monitor-a-real-time-service"></a>使用 Application Insights 監視即時服務

在此練習中，為已部署的預測性服務設定 Application Insights 的程式碼會提供在筆記本中。

1. 在 Jupyter 首頁上，流覽至您複製筆記本存放庫的 **/users/*您的使用者名稱*/mslearn-dp100** 資料夾，然後開啟 [監視模型] 筆記本。
